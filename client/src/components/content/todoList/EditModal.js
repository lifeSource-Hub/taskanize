...
const EditModal = ({getPriorityColor, modalIsOpen, toggle, updateItem, setUpdateItem, update}) =>
{
          ...
          <InputGroup size="sm" className="w-100">
            ...
            <InputGroupAddon className="mr-2" addonType="append">
              <Dropdown
                ...
                <DropdownMenu>
                  <DropdownItem
                    onClick={onChangePriority.bind(null, "High")}>
                    <span
                      className="dot"
                    ...
                    High</DropdownItem>
                  <DropdownItem
                    onClick={onChangePriority.bind(null, "Med")}>
                    <span
                      className="dot"
                    ...
                    Medium</DropdownItem>
                  <DropdownItem
                    onClick={onChangePriority.bind(null, "Low")}>
                    <span
                      className="dot"
